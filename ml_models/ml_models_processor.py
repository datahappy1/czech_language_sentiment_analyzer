...
data_processor_naive_bayes.naive_bayes(PERSIST_MODEL_TO_FILE)
data_processor_logistic_regression.logistic_regression(PERSIST_MODEL_TO_FILE)
data_processor_support_vector_machine.support_vector_machine(PERSIST_MODEL_TO_FILE)
